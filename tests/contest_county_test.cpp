...
int main(int argc, char** argv)
{
    ...
    // ── ContestCatalog ─────────────────────────────────────────────────
    ContestCatalog cat;
    const int n = cat.load(QStringLiteral(SHACKBOOK_CONTESTS_DAT));
    ...
    {
        const QString tmp = QDir::tempPath() + QStringLiteral("/shackbook_contest_status_test.dat");
        QFile f(tmp);
    ...
    // ── countyProgress ─────────────────────────────────────────────────
    CountyList counties;
    const int cn = counties.load(QStringLiteral(SHACKBOOK_COUNTIES_DAT));
